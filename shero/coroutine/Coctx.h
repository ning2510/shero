#ifndef __SHERO_COCTX_H
#define __SHERO_COCTX_H
...
extern "C" {
/**
 * save current register's state to fitst coctx, and from 
 * second coctx take out register's state to assign register
*/

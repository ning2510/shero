...
[Actual] Websocket message format:
  __________________ 16 ______________________
/ 1   1    1    1       4       1       7      \                 16
+---+----+----+----+----------+----+------------+-----------------------------------+
|fin|rsv1|rsv2|rsv3|  opcode  |mask|  payload   |  [For expansion 16 bytes] paylod  |
+---+----+----+----+----------+----+------------+-----------------------------------+
|                          [For expansion 32 bytes] paylod                          |
+-----------------------------------------------+-----------------------------------+
|       [For expansion 16 bytes] paylod         |            Mask-Key               |
+-----------------------------------------------+-----------------------------------+
...
[Ours] Websocket message format:
  __________________ 16 ______________________
/ 1   1    1    1       4       1       7      \                 4
+---+----+----+----+-----------+----+-----------+-----------------------------------+
|fin|rsv1|rsv2|rsv3|  opcode   |mask|  payload  |   [For expansion 4 bytes] paylod  |
+---+----+----+----+-----------+----+-----+-----+-----------------------------------+
|[For expansion 8 bytes] paylod| [4] Mask |             payload data                |
+------------------------------+----------+-----------------------------------------+
|                                  payload data                                     |
+-----------------------------------------------------------------------------------+
|                                     ......                                        |
